cc.Class({
    ...
    gen_level0_map_data: function() {
        ...
        this.qustion_tip_com.spriteFrame = this.anim_sf_set[leve_random[0][1] - 1];
        ...
        for(var w = 0; w < leve_random[3].length; w ++) {
            left_anim.push(leve_random[3][w]);
        }
        ...
        var anim_array = [leve_random[0][0], leve_random[1][0], leve_random[1][1], leve_random[1][2], leve_random[1][3]];
        anim_array.sort(function() {
            return Math.random() - 0.5;
        });
        
        this.min_anim_type = leve_random[0][0];
        this.max_anim_type = leve_random[1][3];
