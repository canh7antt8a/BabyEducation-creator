cc.Class({
    ...
    onLoad: function () {
        ...
        var url = cc.url.raw("resources/sounds/ant.mp3");
        cc.loader.loadRes(url, function() {});
        url = cc.url.raw("resources/sounds/bee.mp3");
        cc.loader.loadRes(url, function() {});
        url = cc.url.raw("resources/sounds/butterfly.mp3");
        cc.loader.loadRes(url, function() {});
        url = cc.url.raw("resources/sounds/firefly.mp3");
        cc.loader.loadRes(url, function() {});
