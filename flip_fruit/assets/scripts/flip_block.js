cc.Class({
    ...
    onLoad: function () {
        ...
        this.label_str = this.node.getChildByName("number").getComponent(cc.Label);
    ...
    flip_anim_back_with_value:function(card_value) {
        this.card_value = card_value[0]; 
        this.card_show_type = card_value[1];
    ...
    flip_to_value: function() {
        ...
        var callback = cc.callFunc(function() {
            if (this.card_show_type == 0) {
                var url = cc.url.raw("resources/game_scene/card_" + (this.card_value-1) + ".png");
                var sf = new cc.SpriteFrame(url);
                this.sprite_com.spriteFrame = sf;     
            }
            else {
                var url = cc.url.raw("resources/game_scene/blank.png");
                var sf = new cc.SpriteFrame(url);
                this.sprite_com.spriteFrame = sf;
