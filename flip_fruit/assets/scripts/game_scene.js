cc.Class({
    ...
    on_game_start: function() {
        var rand_type = [1, 2, 3, 4, 5, 6, 7, 8, 9];
        ...
        this.value_array = [[rand_type[0], 0], [rand_type[1], 0], [rand_type[2], 0], [rand_type[3], 0], 
                            [rand_type[0], 1], [rand_type[1], 1], [rand_type[2], 1], [rand_type[3], 1]];
