cc.Class({
    ...
    onLoad: function () {
        ...
        this.label_str = this.node.getChildByName("label_str").getComponent(cc.Label);
    ...
    flip_anim_back_with_value:function(card_value) {
        this.card_value = card_value[0] + card_value[1]; 
        
        this.lhs_value = card_value[0];
        this.rhs_value = card_value[1];
        this.card_comp_type = card_value[2];
    ...
    flip_to_value: function() {
        ...
        var callback = cc.callFunc(function() {
            var url = cc.url.raw("resources/game_scene/cardvalue.png");
            var sf = new cc.SpriteFrame(url);
            this.sprite_com.spriteFrame = sf; 
            if (this.card_comp_type == 1) {
                this.label_str.string = this.lhs_value + "+" + this.rhs_value;    
            }
            else {
                this.label_str.string = "" + this.card_value;    
            }
