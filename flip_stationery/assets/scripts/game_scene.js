cc.Class({
    ...
    on_game_start: function() {
        ...
        var value_set = [0, 1, 2, 3, 4];
        value_set.sort(function() {
            return Math.random() - 0.5;
        });
        this.value_array = [value_set[0], value_set[0], value_set[1], value_set[1], 
                            value_set[2], value_set[2], value_set[3], value_set[3], 
                            value_set[4], value_set[4], value_set[0], value_set[0], 
                            value_set[1], value_set[1], value_set[2], value_set[2]];
