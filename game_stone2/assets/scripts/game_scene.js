cc.Class({
    ...
    game_enter_main_scene: function() {
        ...
        var func = cc.callFunc(function() {
            var sound_list = [
                "resources/sounds/e11.mp3",
                "resources/sounds/e22.mp3",
                "resources/sounds/e33.mp3",
            ];
    ...
    on_next_part_tree: function(tree) {
        ...
        // 播放树的动画
        var r1 = cc.rotateTo(1, -10);
        var r2 = cc.rotateTo(1, 10);
        var seq = cc.sequence([r1, r2]);
    ...
    on_anim_click1: function() {
        ...
        var sound_list = [
            ...
            "resources/sounds/wa.mp3",
            "resources/sounds/shu.mp3",
        ];
        this.play_sound(sound_list[this.game_mode - 1]);
