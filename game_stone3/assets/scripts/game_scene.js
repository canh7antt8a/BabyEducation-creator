cc.Class({
    ...
    game_enter_scene: function() {
        ...
        if(this.game_mode !== 3) {
            var ske_com = this.scene_set[this.game_mode - 1].getChildByName("anim");
            ske_com.scale = 1;
            
            ske_com = this.scene_set[this.game_mode - 1].getChildByName("anim2");
            ske_com.scale = 1;
            
            ske_com = this.scene_set[this.game_mode - 1].getChildByName("anim3");
            ske_com.scale = 1;
        }
        else {
            var tree = this.scene_set[this.game_mode - 1].getChildByName("anim").getChildByName("tree");
            var frame_com = tree.getComponent("frame_anim");
            frame_com.reset_anim();
            
            tree = this.scene_set[this.game_mode - 1].getChildByName("anim2").getChildByName("tree");
            frame_com = tree.getComponent("frame_anim");
            frame_com.reset_anim();
            
            tree = this.scene_set[this.game_mode - 1].getChildByName("anim3").getChildByName("tree");
            frame_com = tree.getComponent("frame_anim");
            frame_com.reset_anim();
        }
    ...
    on_anim_click2: function() {
        ...
        this.click_mask[1] = 1;
        var ske_com = this.scene_set[this.game_mode - 1].getChildByName("anim2");
        this.on_next_part(ske_com);
    },
    ...
    on_anim_click3: function() {
        ...
        this.click_mask[2] = 1;
        var ske_com = this.scene_set[this.game_mode - 1].getChildByName("anim3");
