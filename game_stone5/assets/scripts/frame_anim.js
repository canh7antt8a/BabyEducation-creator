cc.Class({
    ...
    onLoad: function () {
        this.frames_sp=[]
        var url = cc.url.raw(this.name_prefix + (this.name_begin_index - 1) + ".png");
        
        this.reset_sp = new cc.SpriteFrame(url);
         
        
        for(var i = 0; i < this.frame_count; i ++) {
            url = cc.url.raw(this.name_prefix + (this.name_begin_index + i) + ".png");
    ...
    reset_anim: function() {
        this.sp_comp.spriteFrame = this.reset_sp;
    }, 
