cc.Class({
    ...
    show_cloud_say_hello: function() {
        ...
        // var face_icon = face.getChildByName("hello_icon");
        face_icon.x = 0;
        face_icon.y = 0;
        face_icon.scale = 0;
    ...
    init_game_scene: function() {
        this.rainer = cc.find("UI_ROOT/rain/anchor-center/rainner");
        this.first_down_rain = cc.find("UI_ROOT/rain/anchor-center/down_shui1");
        ...
        this.sec_down_rain = cc.find("UI_ROOT/rain/anchor-center/down_shui2");
    ...
    play_ground_rain: function(water, mode_value) {
        ...
        var seq = cc.sequence([cc.scaleTo(1, 1, 1), func]);
        water.runAction(seq);
    },
    ...
    enter_next_mode: function(mode) {
        ...
        if(mode === 1) { // 第一只雨滴跳出来
            ...
            this.scheduleOnce(function() {
                // 切换到下一个场景
                var scene = cc.find("UI_ROOT/snow");
                scene.active = true;
                var com = scene.getComponent("snow_scene");
                com.init_game_scene();
                com.start_game();
