...
cc.game.onStart = function(){
    ...
    // 如果比16:9狭长和比4/3更短，那么使用SHOW_ALL
    if (size.width * 9 > size.height * 16 || size.width * 3 < size.height * 4) {
        cc.view.setDesignResolutionSize(DESIGN_WIDTH, DESIGN_HEIGHT, cc.ResolutionPolicy.SHOW_ALL);
    }
    else {
        cc.view.setDesignResolutionSize(DESIGN_WIDTH, DESIGN_HEIGHT, cc.ResolutionPolicy.FIXED_WIDTH);
        // cc.view.setDesignResolutionSize(DESIGN_WIDTH, DESIGN_HEIGHT, cc.ResolutionPolicy.SHOW_ALL);
    }
    ...
    cc.LoaderScene.preload(g_resources, function () {
        ...
        cc.director.runScene(new loading_scene());
    ...
    */
    ...
    var _cc = cc;
    if (!_cc.loaderScene) {
        _cc.loaderScene = new loading_scene();
    ...
    /*
    _cc.loaderScene.initWithResources(g_resources, function () {
        cc.director.runScene(SceneManager.getScene());
    }, this); */
