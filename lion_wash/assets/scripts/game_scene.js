cc.Class({
    ...
    play_guli_anim:function(m_type) {
        ...
        this.ske_player_com.setAnimation(0, "zanxixi", true);
        var sound_name = ["resources/sounds/muyulu.mp3", "resources/sounds/feizao.mp3", "resources/sounds/shuazi.mp3", "resources/sounds/huasha.mp3"];
        if (m_type === 1) {
