cc.Class({
    ...
    preload_sound: function() {
        var sound_list = [
            ...
            "resources/sounds/welcome.mp3",
            "resources/sounds/make.mp3",
    ...
    on_game_start: function() {
        ...
        var func = cc.callFunc(function() {
            // top
            cc.find("UI_ROOT/anchor-center/top").getComponent("move_action").move_back();
            cc.find("UI_ROOT/anchor-center/bottom").getComponent("move_action").move_back();
            cc.find("UI_ROOT/anchor-center/logo").getComponent("move_action").move_back();
            cc.find("UI_ROOT/anchor-center/doctor_xiong").getComponent("move_action").move_back();
            cc.find("UI_ROOT/anchor-center/play_node").getComponent("pat_action").move_back();
            // end
            var fto = cc.fadeIn(1);
            cc.find("UI_ROOT/anchor-center/white_mask").runAction(fto);
