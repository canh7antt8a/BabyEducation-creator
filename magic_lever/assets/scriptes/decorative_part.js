cc.Class({
    ...
    onLoad: function () {
        this.move_hit = false;
        this.invalid_move_hit = this.invalid_move;
        ...
        this.node.on('touchmove', function(event) {
            ...
            this.game_scene.hit_car_part(this, world_pos, this.main_type, this.sub_type);
    ...
    on_touch_ended: function() {
        ...
        if(this.move_hit === false && this.move_success === false) {
            ...
            this.game_scene.remove_decor_from_hit_set(this);
            this.node.scale = this.start_scale; 
        }
        else {
            this.move_success = false;
            this.move_hit = false;
            this.invalid_hit_move();
        }
        
        this.game_scene.hide_game_tip_object(this.main_type, this.sub_type);
    }, 
    ...
    on_hit_item: function(delay_time, to_w_pos) {
        ...
        var callback = cc.callFunc(function() {
            // this.move_hit = false;
            // 检车杠杆
            this.game_scene.check_lever_change();
            // end
        }.bind(this), this);
