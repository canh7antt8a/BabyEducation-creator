...
cc.Class({
    ...
    change_lever2: function() {
        ...
        if(this.level_2_1_ok === false && this.hit_set[0][3] !== null && this.hit_set[1][3] !== null && this.hit_set[2][3] !== null) { // 改变第一根杠杆
            ...
            var huo_sai1 = this.front_car_part.getChildByName("huosai1");
        ...
        if (this.level_2_2_ok === false && this.hit_set[3][3] !== null && this.hit_set[4][3] !== null && this.hit_set[5][3] !== null) { // 改变第二根杠杆
            ...
            var huo_sai2 = this.front_car_part.getChildByName("huosai2");
    ...
    change_lever3: function() {
        ...
        if(this.level_3_1_ok === false && this.hit_set[0][3] !== null && this.hit_set[1][3] !== null && this.hit_set[2][3] !== null) { // 改变第一根杠杆
            this.level_3_1_ok = true;
            var huo_sai1 = this.back_car_part.getChildByName("huosai2");
            huo_sai1.active = true;

            if(this.level_3_2_ok === false) {
                if(this.hit_set[3][3]) {
                    this.hit_set[3][3].active = true;
                }
                if(this.hit_set[4][3]) {
        ...
        if (this.level_3_2_ok === false && this.hit_set[3][3] !== null && this.hit_set[4][3] !== null && this.hit_set[5][3] !== null) { // 改变第二根杠杆
    ...
    enter_car_back_mode: function() {
        ...
        var huo_sai1 = this.back_car_part.getChildByName("qiqiu_root").getChildByName("huosai1");
        huo_sai1.active =false;
        ...
        main_car_com.set_start_pos(xpos, ypos);
        xpos = xpos - delta;
        main_car = cc.instantiate(this.decro_prfabs[6].sub_set[0]);
        this.car_parts.addChild(main_car);
        var main_car_com = main_car.getComponent("decorative_part");
        main_car_com.set_start_pos(xpos, ypos);
        xpos = xpos - delta;
    ...
    play_pass_level1: function() {
        ...
        var ci_lun = this.main_car_part.getChildByName("cilun");
