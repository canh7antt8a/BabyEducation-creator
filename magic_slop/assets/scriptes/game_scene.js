...
cc.Class({
    ...
    enter_main_car_model: function() {
        ...
        this.car_parts.addChild(main_car);
        var main_car_com = main_car.getComponent("decorative_part");
        main_car_com.set_start_pos(xpos, ypos + 30);
        xpos = xpos + delta;
        main_car.active = true;
    },
    ...
    enter_car_front_mode: function() {
        ...
        for(var index = 0; index < 3; index ++) {
            car_part = cc.instantiate(this.decro_prfabs[0].sub_set[0]);
            this.car_parts.addChild(car_part);
            var car_part_com = car_part.getComponent("decorative_part");
            car_part_com.set_start_pos(xpos, ypos);
            xpos = xpos + delta;
            car_part.active = true;
        }
        
        car_part = cc.instantiate(this.decro_prfabs[1].sub_set[0]);
        this.car_parts.addChild(car_part);
        var car_part_com = car_part.getComponent("decorative_part");
        car_part_com.set_start_pos(xpos, ypos);
        xpos = xpos + delta;
        ...
        car_part = cc.instantiate(this.decro_prfabs[2].sub_set[0]);
        this.car_parts.addChild(car_part);
        var car_part_com = car_part.getComponent("decorative_part");
        car_part_com.set_start_pos(xpos, ypos + 56);
        xpos = xpos + delta;
        car_part.active = true;
    ...
    enter_car_back_mode: function() {
        ...
        car_part = cc.instantiate(this.decro_prfabs[2].sub_set[1]);
        this.car_parts.addChild(car_part);
        var car_part_com = car_part.getComponent("decorative_part");
        car_part_com.set_start_pos(xpos, ypos + 56);
        xpos = xpos + delta;
