...
cc.Class({
    ...
    change_car_part: function(car_main, sub_type, main_type) {
        ...
        if (this.game_mode === 3) {
            // 显示开出汽车的按钮
            if (this.factory_ok.active === false) {
                this.factory_ok.active = true;
                var move = cc.moveBy(0.5, 335, 0);
    ...
    enter_main_car_model: function() {
        ...
        for(var i = 0; i < this.main_car_prefabs.length; i ++) {
            ...
            main_car_com.set_start_pos(xpos, ypos - 80);
            xpos = xpos + delta;
            main_car.active = true;
        }
    ...
    enter_car_front_mode: function() {
        ...
        for(var i = 0; i < this.front_car_prefabs.length; i ++) {
            ...
            front_car_com.set_start_pos(xpos - 200, ypos - 80);
    ...
    on_out_factory_click: function() {
        ...
        body_actions.push(cc.delayTime(1.5));
        ...
        this.main_car_part.getComponent("car_part").play_wheel_anim();
        this.front_car_part.getComponent("car_part").play_wheel_anim();
        this.back_car_part.getComponent("car_part").play_wheel_anim();
        /*
    ...
    enter_car_back_mode: function() {
        ...
        for(var i = 0; i < this.back_car_prefabs.length; i ++) {
            ...
            back_car_com.set_start_pos(xpos + 80, ypos - 80);
