...
cc.Class({
    ...
    change_lever2: function() {
        ...
        if(this.level_2_1_ok === false && this.hit_set[0][3] !== null && this.hit_set[1][3] !== null) { // 改变第一根杠杆
            ...
            var com_left = this.hit_set[0][3].getComponent("evl_move2");
            com_left.add_by(294);
            com_left.move_by(1, -294);
            
            var shenzi = this.front_car_part.getChildByName("shenzi")
            shenzi.active = true;
            
            var com_right = this.hit_set[1][3].getComponent("evl_move2");
            com_right.move_by(1, 294);
        }
    ...
    change_lever3: function() {
        ...
        if(this.level_3_1_ok === false && this.hit_set[0][3] !== null && this.hit_set[1][3] !== null) { // 改变第一根杠杆
            ...
            var shenzi = this.back_car_part.getChildByName("shenzi1")
            shenzi.active = true;
            
            var com_left = this.hit_set[0][3].getChildByName("move_diandi").getComponent("evl_move");
            com_left.add_by(390);
            com_left.move_by(1, -390);
            
            var com_right = this.hit_set[1][3].getChildByName("move_diandi").getComponent("evl_move");
            com_right.move_by(1, 390);
        }
        
        if (this.level_3_2_ok === false && this.hit_set[2][3] !== null && this.hit_set[3][3] !== null) { // 改变第二根杠杆
            this.level_3_2_ok = true;
            var shenzi = this.back_car_part.getChildByName("shenzi2")
            shenzi.active = true;
            
            var com_left = this.hit_set[2][3].getComponent("evl_move2");
            // com_left.add_by(160);
            com_left.move_by(1, 200);
            
            var com_right = this.hit_set[3][3].getChildByName("move_diandi").getComponent("evl_move");
            com_right.move_by(1, 160);
        }
    }, 
    ...
    enter_car_front_mode: function() {
        ...
        main_car = cc.instantiate(this.decro_prfabs[5].sub_set[0]);
        this.car_parts.addChild(main_car);
        var main_car_com = main_car.getComponent("decorative_part");
        main_car_com.set_start_pos(xpos, ypos);
        xpos = xpos - delta;
    ...
    enter_car_back_mode: function() {
        ...
        var main_car = cc.instantiate(this.decro_prfabs[5].sub_set[0]);
        this.car_parts.addChild(main_car);
        var main_car_com = main_car.getComponent("decorative_part");
        main_car_com.set_start_pos(xpos, ypos);
        xpos = xpos - delta;
    ...
    play_pass_level1: function() {
        ...
        var men1 = this.main_car_part.getChildByName("zhongwu_men1");
        var men2 = this.main_car_part.getChildByName("zhongwu_men2");
        
        var walk1_time = 1.5;
        var func1 = cc.callFunc(function() {
            var m1 = cc.moveBy(walk1_time, 345, 0);
            machine_man.runAction(m1);
        }.bind(this), this);
        
        var down_time = 0.3;
        var func2 = cc.callFunc(function() {
            var rot = cc.rotateBy(0.1, 90);
            men1.runAction(rot);
            men2.runAction(cc.rotateBy(0.1, -90));
            this.hit_set[2][3].runAction(cc.moveBy(down_time, 0, -200));
        }.bind(this), this);
        ...
        var func3 = cc.callFunc(function(){
            var com_left = this.hit_set[0][3].getChildByName("move_diandi").getComponent("evl_move");
            com_left.move_by(up_time, -270);
            
            this.hit_set[2][3].runAction(cc.moveBy(up_time, 0, -270));
            machine_man.runAction(cc.moveBy(up_time, 0, 270));
            
            var com_right = this.hit_set[1][3].getChildByName("move_diandi").getComponent("evl_move");
            com_right.move_by(up_time, 270);
            
        }.bind(this), this);
        
        var func4 = cc.callFunc(function() {
            var m1 = cc.moveBy(walk1_time, 375, 0);
            machine_man.runAction(m1);
        }.bind(this), this);
            
        var seq = cc.sequence([func1, cc.delayTime(walk1_time), func2, cc.delayTime(down_time), func3, cc.delayTime(up_time), func4]);
    ...
    play_pass_level2: function() {
        ...
        var men1 = this.front_car_part.getChildByName("zhongwu_men1");
        var men2 = this.front_car_part.getChildByName("zhongwu_men2");
        
        var walk1_time = 3;
        var func1 = cc.callFunc(function() {
            var m1 = cc.moveBy(walk1_time, 640, 0);
            machine_man.runAction(m1);
        }.bind(this), this);
        ...
        var func2 = cc.callFunc(function() {
            ...
            men1.runAction(rot);
            men2.runAction(cc.rotateBy(0.1, -90));
            this.hit_set[2][3].runAction(cc.moveBy(down_time, 0, -280));
        }.bind(this), this);
        ...
        var func3 = cc.callFunc(function(){
            var len_ypos = 298
            var com_left = this.hit_set[0][3].getComponent("evl_move2");
            com_left.move_by(up_time, len_ypos);
            
            this.hit_set[2][3].runAction(cc.moveBy(up_time, 0, -len_ypos));
            machine_man.runAction(cc.moveBy(up_time, 0, len_ypos));
            
            var com_right = this.hit_set[1][3].getComponent("evl_move2");
            com_right.move_by(up_time, -len_ypos);
            
        }.bind(this), this);
        
        var func4 = cc.callFunc(function() {
            var m1 = cc.moveBy(walk1_time, -650, 0);
            machine_man.scaleX = -machine_man.scaleX;
            machine_man.runAction(m1);
        }.bind(this), this);
    ...
    play_pass_level3: function() {
        ...
        var men1 = this.back_car_part.getChildByName("zhongwu_men1");
        var men2 = this.back_car_part.getChildByName("zhongwu_men2");
        var men3 = this.back_car_part.getChildByName("zhongwu_men3");
        
        var walk1_time = 1.5;
        var func1 = cc.callFunc(function() {
            machine_man.runAction(cc.moveBy(walk1_time, 250, 0));
        }.bind(this), this);
        ...
        var func2 = cc.callFunc(function() {
            ...
            men1.runAction(rot);
            men2.runAction(cc.rotateBy(0.1, -90));
            this.hit_set[4][3].runAction(cc.moveBy(down_time, 0, -200));
        }.bind(this), this);
        ...
        var func3 = cc.callFunc(function(){
            var com_left = this.hit_set[0][3].getChildByName("move_diandi").getComponent("evl_move");
            com_left.move_by(up_time, 206);
            
            this.hit_set[4][3].runAction(cc.moveBy(up_time, 0, -206));
            machine_man.runAction(cc.moveBy(up_time, 0, 206));
            
            var com_right = this.hit_set[1][3].getChildByName("move_diandi").getComponent("evl_move");
            com_right.move_by(up_time, -206);
            
        }.bind(this), this);
        
        var func4 = cc.callFunc(function() {
            machine_man.runAction(cc.moveBy(walk1_time, 570, 0));
        }.bind(this), this);
        ...
        var func5 = cc.callFunc(function() {
            ...
            this.hit_set[5][3].runAction(cc.moveBy(up_time, 0, -len_ypos));
            machine_man.runAction(cc.moveBy(up_time, 0, len_ypos));
        ...
        var func6 = cc.callFunc(function(){
            machine_man.runAction(cc.moveBy(1, 220, 0));
        }.bind(this), this)
        
        var func7 = cc.callFunc(function(){
        ...
        var seq = cc.sequence([func1, cc.delayTime(walk1_time), func2, cc.delayTime(down_time), func3, cc.delayTime(up_time), func4, cc.delayTime(walk1_time + 0.2), func5, cc.delayTime(up_time + 0.1), func6, cc.delayTime(1), func7]);
