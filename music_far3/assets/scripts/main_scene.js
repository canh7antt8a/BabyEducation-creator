cc.Class({
    ...
    onLoad: function () {
        ...
        cc.find("UI_ROOT/anchor-center/anim_root").active = false;
    },
    ...
    on_start_game: function() {
        ...
        cc.find("UI_ROOT/anchor-center/anim_root").active = true;
        ...
        for(var i = 0; i < 3; i ++) {
            ...
            this.anim_set2[index].active = false;
            // this.play_idle_when_start(this.anim_set[index], index + 1);
        }
        
        for(var i = 3; i < this.anim_set.length; i ++) {
            var index = this.game_map[i];
    ...
    on_anim_click: function(index) {
        ...
        if(type == index - 1) {
            ...
            var anim2 = this.anim_set2[index - 1];
            this.play_jiao(anim2, index);
            anim.active = false;
            anim2.active = true;
