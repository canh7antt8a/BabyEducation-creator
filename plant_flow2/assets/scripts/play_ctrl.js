cc.Class({
    ...
    onLoad: function () {
        ...
        this.throw_frame = [];
        for(var i = 1; i <= 8; i ++ ) {
            url = cc.url.raw("resources/textures/game_scene/" + i + ".png");
            this.throw_frame.push(new cc.SpriteFrame(url));    
        }
    ...
    play_throw_flow_anim: function() {
        ...
        var start_ypos_set = [-98, -98, -98];
        var delay;
        this.hit_flow = [];
        
        this.throw_frame.sort(function() {
        ...
        for(var i = 0; i < 3; i ++) {
            ...
            for(var j = 0; j < 10; j ++) { // 左边的
                ...
                sprite_com.spriteFrame = this.throw_frame[s_i].clone();
