...
var game_scene = cc.Scene.extend({
    onEnter:function () {
        ...
        this.cat_play_action_type1 = create_frame_action([res.jx_miao_1_png, res.jx_miao_5_png, res.jx_miao_6_png, res.jx_miao_5_png, res.jx_miao_1_png], 0.20 / 4);
        ...
        this.cat_play_action_type2 = create_frame_action([res.jx_miao_1_png, res.jx_miao_3_png, res.jx_miao_4_png, res.jx_miao_3_png, res.jx_miao_1_png], 0.28 / 4);
    ...
    on_left_action: function() {
        ...
        action.gotoFrameAndPlay(0, 12, false);
        // action.play("player_action_type1", false);
        this.game_scene_ccs.node.runAction(action);
        this.compute_score(1);
        /*
        var seq = cc.Sequence.create([cc.DelayTime.create(0.2), cc.CallFunc.create(function() {
            this.text_label.setVisible(false);
        }.bind(this))]);
        this.text_label.stopAllActions();
        this.text_label.runAction(seq);*/
    },

    on_right_action:function() {
        var action = this.right_play_action.clone();
        action.gotoFrameAndPlay(140, 160, false);
        // action.play("player_action_type2", false);
        this.game_scene_ccs.node.runAction(action);
    ...
    on_play_game:function() {
        ...
        leave_action.gotoFrameAndPlay(1, 60, false);
