var checkout = cc.Node.extend({
	init_checkout: function() {
		...
		var cat_anim = fa_create_forever_with_file(
			[res.checkout_monkey1_png, res.checkout_monkey2_png, res.checkout_monkey3_png, 
			res.checkout_monkey4_png], 
			0.4 / 3); 
		anchor_center.addChild(cat_anim);

		var good_anim = fa_create_forever_with_file(
			[res.checkout_good1_png, res.checkout_good2_png, res.checkout_good3_png, 
			res.checkout_good4_png], 
			0.4 / 3); 
		anchor_center.addChild(good_anim)
		good_anim.setPosition(0, 110);
		this.good_anim = good_anim;
