cc.Class({
    ...
    preload_sound: function() {
        var sound_list = [
            ...
            "resources/sounds/piano/elem_22.mp3",
            "resources/sounds/piano/elem_23.mp3",
            "resources/sounds/piano/elem_24.mp3",
            "resources/sounds/piano/elem_25.mp3",
            "resources/sounds/piano/elem_26.mp3",
            "resources/sounds/piano/elem_27.mp3",
            "resources/sounds/piano/elem_28.mp3",
            "resources/sounds/piano/elem_29.mp3",
    ...
    onLoad: function () {
        ...
        var sp_frame = new cc.SpriteFrame(url);
        this.kim_idel_sp = sp_frame;
        
        this.yinfu = cc.find("UI_ROOT/anchor-center/yinfu");
        console.log(this.yinfu);
        ...
        cc.find("UI_ROOT/anchor-center/kim_cat").active = false;
        cc.find("UI_ROOT/anchor-center/kim_idle").active = true;
    },
    ...
    play_hole_music: function() {
        ...
        cc.find("UI_ROOT/anchor-center/kim_cat").active = true;
        cc.find("UI_ROOT/anchor-center/kim_idle").active = false;
    ...
    // 播放激励动画
    play_good_anim: function() {
        var delay = 0.01;
        for(var i = 0; i < this.mid_anim_items.length; i ++) {
            var star = this.mid_anim_items[i];
            var comp = star.getComponent("frame_anim_second");
            comp.play_after_delay(delay);
            delay += 0.15;
        }
    }, 
