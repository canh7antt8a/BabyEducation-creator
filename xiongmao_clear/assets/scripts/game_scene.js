cc.Class({
    ...
    play_guli_anim:function(m_type) {
        ...
        this.ske_player_com.setAnimation(0, "guli", true);
        var sound_name = ["resources/sounds/tuoba.mp3", "resources/sounds/saoba.mp3", "resources/sounds/mabu.mp3", 
                           "resources/sounds/pengtou.mp3", "resources/sounds/xichengqi.mp3"];
